...
func GetGoogleOauthToken(code string) (*GoogleOauthToken, error) {
	...
	values.Add("client_id", config.Config["GoogleClientID"].(string))
	values.Add("client_secret", config.Config["GoogleClientSecret"].(string))
	values.Add("redirect_uri", config.Config["GoogleRedirectURI"].(string))
